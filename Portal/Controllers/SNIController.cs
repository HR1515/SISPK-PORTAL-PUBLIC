    ...
    public class SNIController : Controller
    {
        ...
        public ActionResult ListDataSNI(DataTables param, string nomor = "", int komtek = 0, string judul = "", int tahun = 0, int status = 0, int status_sni = 2, string ics = "")
        {
            ...
            { 
                ...
                Convert.ToString((Session["USER_ID"] != null)?(list.SNI_TIDAK_BERLAKU != 1 && list.PROPOSAL_IS_BATAL != 1 && list.DSNI_DOC_FILE_NAME != "SNI")?"<center><a href='"+link.LINK_NAME+"/Download/Files?fid="+list.PROPOSAL_ID+"&token_key="+Session["TOKEN_KEY"]+"&uid="+Session["USER_ID"]+"'><img border='0' width='15' height='15' alt='download pdf' src='http://sisni.bsn.go.id//static/images/pdf.ico'></a></center>":"File Tidak Ada":(list.SNI_TIDAK_BERLAKU != 1 && list.PROPOSAL_IS_BATAL != 1 && list.DSNI_DOC_FILE_NAME != "SNI")?"<center><a href='#' onclick='peringatan_login()'><img border='0' width='15' height='15' alt='download pdf' src='http://sisni.bsn.go.id//static/images/pdf.ico'></a></center>":"File Tidak Ada")
                //Convert.ToString((Session["USER_ID"] != null && list.SNI_TIDAK_BERLAKU != 1 && list.PROPOSAL_IS_BATAL != 1)?"-":"-")
            };
            return Json(new
            {
                sEcho = param.sEcho,
